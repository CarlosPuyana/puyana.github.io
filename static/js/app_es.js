document.querySelector('#dark-mode-toggle').addEventListener('click', () => {
    ...
    document.querySelector('meta[name="theme-color"').setAttribute('content', isDarkMode ? '#1a1a2e' : '#ffff');
});
...
// Añadimos espacio por cada 9 celdas
...
const initSudoku = () => {
    // Limpiar el anterior sudoku
    clearSudoku();
    resetBg();
    // Generamos un puzzle de sudoku 
    su = sudokuGen(level);
...
// Añadimos el evento del boton

var check = document.querySelector('#switch1')

document.querySelector('#switch1').addEventListener('click', () => {
    let id = check.checked;

    console.log(check.checked + " entro")
